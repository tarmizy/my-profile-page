...
export default function MobileServices() {
  return (
    <section id="layanan" className="page-panel page-panel-services" style={{ padding: '50px 16px' }}>
      <MotionReveal className="section-head"><h2 className="title">Digital products yang terasa premium</h2><p className="subtitle">Web3D, aplikasi operasional, dan deployment dalam satu pengalaman digital yang utuh.</p></MotionReveal>
